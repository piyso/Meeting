...
.surface-glass-premium {
  ...
  box-shadow:
    ...
    /* Deep drop shadow */ 0 1px 0 0 rgba(255, 255, 255, 0.1) inset,
    /* Top inner rim light */ 0 0 0 1px rgba(255, 255, 255, 0.05); /* Subtle outer stroke */
...
**CAUTION:** Do NOT apply `will-change` globally or to >10 elements. Chromium allocates a separate VRAM texture for each promoted layer. Over-promotion causes GPU memory exhaustion and paradoxically _decreases_ performance.
