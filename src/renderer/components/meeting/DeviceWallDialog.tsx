...
export const DeviceWallDialog: React.FC<DeviceWallDialogProps> = ({
  open,
  onClose,
  currentDevices,
  maxDevices,
    ...
    <Dialog open={open} onClose={onClose} width={440}>
      <div className="flex flex-col items-center text-center p-[var(--space-8)]">
        ...
        <p className="text-[var(--text-sm)] text-[var(--color-text-secondary)] mb-[var(--space-24)] leading-relaxed">
          Your Starter plan supports up to {maxDevices} devices. Upgrade to Pro for unlimited
          devices and seamless syncing everywhere.
        </p>
