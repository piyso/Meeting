...
export const IntelligenceWallDialog: React.FC<IntelligenceWallDialogProps> = ({
  open,
  onClose,
  queriesUsed,
  queryLimit,
    ...
    <Dialog open={open} onClose={onClose} width={440}>
      <div className="flex flex-col items-center text-center p-[var(--space-8)]">
        ...
        <p className="text-[var(--text-sm)] text-[var(--color-text-secondary)] mb-[var(--space-24)] leading-relaxed">
          You've used {queriesUsed}/{queryLimit} cloud AI queries this month. Upgrade to Pro for
          unlimited queries, or continue with local AI (reduced accuracy).
        </p>
